...
;~ Simple script for Polisch diacritic marks (https://en.wikipedia.org/wiki/Diacritic): ¹, ê, œ, æ, ¿, Ÿ, ñ, ó, ³.
;~ Instead of usage of AltGr (right alt, see https://en.wikipedia.org/wiki/AltGr_key#Polish for further details):
;~ * double press a key corresponding to specific diacritic key, e.g. ee converts into ê
...
ABOUT:
    ...
    Gui, MyAbout: Font
    Gui, MyAbout: Add, Text, x+1, ): ¹, ê, œ, æ, ¿, Ÿ, ñ, ó, ³.
    ...
    Gui, MyAbout: Add, Text, xm+20, * double press a key corresponding to specific diacritic key`, e.g. ee converts into ê
