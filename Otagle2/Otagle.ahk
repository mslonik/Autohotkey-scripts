...
Traymenu:
     Menu, Tray,                Icon, % A_ScriptDir . "\OtagleIcon.ico"    ; this line applies icon of O T A G L E designed by Sylwia £awrów
...
L_About:
     ...
     Gui, MyAbout: Font
     Gui, MyAbout: Add, Picture, xm+50 y+20 w300 h-1, % A_ScriptDir . "\OtagleBigLogo.png" ; Add the O T A G L E picture designed by Sylwia £awrów
...
F_WelcomeScreen()
     ...
     Gui, WelcomeScreen: Add, Picture, w500 h-1, % A_ScriptDir . "\OtagleBigLogo.png" ; Add the O T A G L E picture designed by Sylwia £awrów 
     DetectHiddenWindows, On
